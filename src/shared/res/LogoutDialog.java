...
/**
 * A customizable message dialog for logging out.
 */
public class LogoutDialog extends JDialog {
    ...
    /**
     * Constructs a LogoutDialog with customizable content.
     *
     ...
     */
    public LogoutDialog(String title, ImageIcon icon, String titleMessage, String message, String buttonText, Color buttonColor, Color iconColor, Color textColor, Color titleMessageColor) {
        this.title = title;
        this.icon = icon;
    ...
    private void createDialog() {
        ...
        btnCancel = style.createBtnRounded("CANCEL", style.celadon, style.white, 10);
