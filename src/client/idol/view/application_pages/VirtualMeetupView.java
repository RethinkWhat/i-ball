...
public class VirtualMeetupView extends JPanel {
    ...
    class CallPanel extends JPanel {
        public CallPanel() {
            ...
            lblFanPfp = style.createLblIconOnly(style.iconPfpPlaceholder, 120,120);
            lblFanPfp.setHorizontalAlignment(SwingConstants.CENTER);
            container.add(lblFanPfp, gbc);

            gbc.gridy = 2;
            gbc.anchor = GridBagConstraints.WEST;
            lblFanName = style.createLblH3("Info", style.white);
            lblFanName.setHorizontalAlignment(SwingConstants.LEFT);
            container.add(lblFanName, gbc);

            gbc.gridx = 1;
            gbc.anchor = GridBagConstraints.EAST;
            lblIdolPfp = style.createLblIconOnly(style.iconPfpPlaceholder, 60,60);
            lblIdolPfp.setHorizontalAlignment(SwingConstants.RIGHT);
